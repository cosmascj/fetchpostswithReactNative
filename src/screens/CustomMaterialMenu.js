...
const CustomMaterialMenu = (props) => {
  ...
  return (
    <View style={props.menustyle}>
        ...
        button={
          props.isIcon ? (
            <TouchableOpacity onPress={() => _menu.show()}>
              <Image
                source={{
                  uri: "https://raw.githubusercontent.com/AboutReact/sampleresource/master/menu_icon.png",
                }}
      ...
      >
        {props.route.name === "App_to_Home" ? (
          <MenuItem
            onPress={() => {
              props.navigation.navigate("Blog Comments");
              _menu.hide();
            }}
          >
            Go to second Page
        ...
        {props.route.name === "Blog Comments" ? (
          <MenuItem
            onPress={() => {
              props.navigation.navigate("App_to_Home");
              _menu.hide();
            }}
          >
            Go to first Page
